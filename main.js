const f = (() => {
  ...
  // color scheme: Tol bright, https://cran.r-project.org/web/packages/khroma/vignettes/tol.html
  const very_light_red = "#fae1e4";
  const very_light_green = "#cfe5d2";
  const very_light_blue = "#cfdae5";
  const very_light_yellow = "#f2efda";
  const very_light_silver = "#f0f0f0";
  const light_red = "#edb9c0"; // old: "#ebc8c8";
  const light_green = "#5dba6d"; // old: "#d0ebc8"
  const light_blue = "#699dd1"; // old: "#C8D5EB"
  const light_yellow = "#e5d673"; // old: "#ebe6c8"
  const light_silver = "#ebebeb";
  const dark_red = "#EE6677"; // old: "#d14c4c"
  const dark_green = "#228833"; // old: "#6bd14c"
  const dark_blue = "#4477AA"; // old: "#4C7DD1"
  const dark_yellow = "#CCBB44"; // old: "#d1bd4c"
  const dark_silver = "#D1D1D1";


  if (theme == "dark") {
    var color_square_bg = "#1e1e20";
    var color_square_bg_border = "#232328";
    var color_square_fg = "#28282d";
    var color_square_fg_border = "#31313d";
    var color_wall = "#010203";
    var color_center = "#131314";
  } else {
    var color_square_bg = "#e7d7ce";
  ...
  function getPath(color="r", d="M150, 250 L150,1065") {
    ...
    switch (color) {
      case "r":
        hexColor = dark_red; // old: "e14a47"
        break;
      case "b":
        hexColor = dark_blue; // old: "4C7DD1"
        break;
      case "g":
        hexColor = dark_green; // old: "6bd14c"
        break;
      case "y":
        hexColor = dark_yellow; // old: "c1a530"
        break;
      default:
        hexColor = "#888888";
        break;
  ...
  function getRobot(a) {
    ...
    returnRobot.innerHTML = `<path class="st0" d="M83.7,147.5c0,0-5.6,4-8.6,15s6,25,6,25L95.7,171c0,0-4.5-8.5,6.5-19.5s-9-4-9-4H83.7z"/>
      ...
      <path class="st3`+a+`" d="M83,193.8c46,25.2,96.9,26.2,140-0.8"/>
  ...
  svg.innerHTML = `<style>
      ...
      .st1r{fill:${light_red};stroke:#000000;stroke-width:2.5;stroke-miterlimit:10;}
      .st1b{fill:${light_blue};stroke:#000000;stroke-width:2.5;stroke-miterlimit:10;}
      .st1g{fill:${light_green};stroke:#000000;stroke-width:2.5;stroke-miterlimit:10;}
      .st1y{fill:${light_yellow};stroke:#000000;stroke-width:2.5;stroke-miterlimit:10;}
      .st1s{fill:${light_silver};stroke:#000000;stroke-width:2.5;stroke-miterlimit:10;}
      .st3r{fill:none;stroke:${dark_red};stroke-width:27.2153;stroke-miterlimit:10;}
      .st4r{fill:${dark_red};stroke:#000000;stroke-width:2;stroke-miterlimit:10;}
      .st3b{fill:none;stroke:${dark_blue};stroke-width:27.2153;stroke-miterlimit:10;}
      .st4b{fill:${dark_blue};stroke:#000000;stroke-width:2;stroke-miterlimit:10;}
      .st3g{fill:none;stroke:${dark_green};stroke-width:27.2153;stroke-miterlimit:10;}
      .st4g{fill:${dark_green};stroke:#000000;stroke-width:2;stroke-miterlimit:10;}
      .st3y{fill:none;stroke:${dark_yellow};stroke-width:27.2153;stroke-miterlimit:10;}
      .st4y{fill:${dark_yellow};stroke:#000000;stroke-width:2;stroke-miterlimit:10;}
      .st3s{fill:none;stroke:${dark_silver};stroke-width:27.2153;stroke-miterlimit:10;}
      .st4s{fill:${dark_silver};stroke:#000000;stroke-width:2;stroke-miterlimit:10;}
  ...
  defs.appendChild(getArrowheads(dark_red, "r"));
  defs.appendChild(getArrowheads(dark_blue, "b"));
  defs.appendChild(getArrowheads(dark_green, "g"));
  defs.appendChild(getArrowheads(dark_yellow, "y"));
  ...
  symbolSqI.appendChild(getRect("0", "0", "100", "100", color_square_bg, color_square_bg_border, "5", "1"));
  symbolSqI.appendChild(getRect("15", "15", "70", "70", color_square_fg, color_square_fg_border, "5", "0.6"));
  symbolSqI.appendChild( getPolyline("0,0 0,110", "none", color_wall, "20") );
  ...
  symbolSqII.appendChild(getRect("0", "0", "100", "100", color_square_bg, color_square_bg_border, "5", "1"));
  symbolSqII.appendChild(getRect("15", "15", "70", "70", color_square_fg, color_square_fg_border, "5", "0.6"));
  symbolSqII.appendChild( getPolyline("0,0 0,150 100,150 100,-50", "none", color_wall, "20") );
  ...
  symbolSqL.appendChild(getRect("0", "0", "100", "100", color_square_bg, color_square_bg_border, "5", "1"));
  symbolSqL.appendChild(getRect("15", "15", "70", "70", color_square_fg, color_square_fg_border, "5", "0.6"));
  symbolSqL.appendChild( getPolyline("0,0 0,100 110,100", "none", color_wall, "20") );
  ...
  symbolSqLD.appendChild(getRect("0", "0", "100", "100", color_square_bg, color_square_bg_border, "5", "1"));
  symbolSqLD.appendChild(getRect("15", "15", "70", "70", color_square_fg, color_square_fg_border, "5", "0.6"));
  symbolSqLD.appendChild( getPolyline("100,0 100,0", "none", color_wall, "20") );
  symbolSqLD.appendChild( getPolyline("0,0 0,100 110,100", "none", color_wall, "20") );
  ...
  symbolSqU.appendChild(getRect("0", "0", "100", "100", color_square_bg, color_square_bg_border, "5", "1"));
  symbolSqU.appendChild(getRect("15", "15", "70", "70", color_square_fg, color_square_fg_border, "5", "0.6"));
  symbolSqU.appendChild( getPolyline("0,0 0,100 100,100 100,0", "none", color_wall, "20") );
  ...
  symbolSqD.appendChild(getRect("0", "0", "100", "100", color_square_bg, color_square_bg_border, "5", "1"));
  symbolSqD.appendChild(getRect("15", "15", "70", "70", color_square_fg, color_square_fg_border, "5", "0.6"));
  symbolSqD.appendChild( getPolyline("0,0 0,0", "none", color_wall, "20") );
  ...
  symbolSqDD.appendChild(getRect("0", "0", "100", "100", color_square_bg, color_square_bg_border, "5", "1"));
  symbolSqDD.appendChild(getRect("15", "15", "70", "70", color_square_fg, color_square_fg_border, "5", "0.6"));
  symbolSqDD.appendChild( getPolyline("100,0 100,0", "none", color_wall, "20") );
  symbolSqDD.appendChild( getPolyline("100,100 100,100", "none", color_wall, "20") );
  ...
  symbolSqDDd.appendChild(getRect("0", "0", "100", "100", color_square_bg, color_square_bg_border, "5", "1"));
  symbolSqDDd.appendChild(getRect("15", "15", "70", "70", color_square_fg, color_square_fg_border, "5", "0.6"));
  symbolSqDDd.appendChild( getPolyline("0,0 0,0", "none", color_wall, "20") );
  symbolSqDDd.appendChild( getPolyline("100,100 100,100", "none", color_wall, "20") );
  ...
  symbolSqIDr.appendChild(getRect("0", "0", "100", "100", color_square_bg, color_square_bg_border, "5", "1"));
  symbolSqIDr.appendChild(getRect("15", "15", "70", "70", color_square_fg, color_square_fg_border, "5", "0.6"));
  symbolSqIDr.appendChild( getPolyline("0,0 0,0", "none", color_wall, "20") );
  symbolSqIDr.appendChild( getPolyline("100,0 100,100", "none", color_wall, "20") );
  ...
  symbolSqIDl.appendChild(getRect("0", "0", "100", "100", color_square_bg, color_square_bg_border, "5", "1"));
  symbolSqIDl.appendChild(getRect("15", "15", "70", "70", color_square_fg, color_square_fg_border, "5", "0.6"));
  symbolSqIDl.appendChild( getPolyline("0,0 0,0", "none", color_wall, "20") );
  symbolSqIDl.appendChild( getPolyline("0,100 100,100", "none", color_wall, "20") );
  ...
  sq.appendChild(getRect("0", "0", "100", "100", color_square_bg, color_square_bg_border, "5", "1"));
  sq.appendChild(getRect("15", "15", "70", "70", color_square_fg, color_square_fg_border, "5", "0.6"));
  ...
  const blkRect = getRect("0", "0", "100", "100", color_center, "none", "5", "1");
  ...
  blkPolyline.setAttribute("stroke", color_wall);
  ...
  if (["r", "g", "b", "y", "s"].includes(goalID[0]) && goalID[1] >= 0) {
    ...
    const goalInner = document.createElementNS("http://www.w3.org/2000/svg", "circle");
    goalInner.setAttribute("cx", "0.5");
    goalInner.setAttribute("cy", "0.5");
    goalInner.setAttribute("r", "0.175");
    goalInner.setAttribute("stroke-width", "0");
    goalInner.setAttribute("opacity", "1");
    const goalOuter = document.createElementNS("http://www.w3.org/2000/svg", "circle");
    goalOuter.setAttribute("cx", "0.5");
    goalOuter.setAttribute("cy", "0.5");
    goalOuter.setAttribute("r", "0.4");
    goalOuter.setAttribute("stroke-width", "0.15");
    goalOuter.setAttribute("opacity", "1");
    const symbolGoal = document.createElementNS("http://www.w3.org/2000/svg", "symbol");
    symbolGoal.setAttribute("id", "goal");
    symbolGoal.setAttribute("viewBox", "-0.04 -0.04 16 16");
    symbolGoal.setAttribute("transform", "scale(0.75, 0.75) translate(12, 12)");
    symbolGoal.appendChild(goalOuter);
    symbolGoal.appendChild(goalInner);
    
    switch (goalID[0]) {
      case 'r':
        goalInner.setAttribute("fill", dark_red);
        goalOuter.setAttribute("fill", very_light_red);
        goalOuter.setAttribute("stroke", dark_red);
        break;
      case 'g':
        goalInner.setAttribute("fill", dark_green);
        goalOuter.setAttribute("fill", very_light_green);
        goalOuter.setAttribute("stroke", dark_green);
        break;
      case 'b':
        goalInner.setAttribute("fill", dark_blue);
        goalOuter.setAttribute("fill", very_light_blue);
        goalOuter.setAttribute("stroke", dark_blue);
        break;
      case 'y':
        goalInner.setAttribute("fill", dark_yellow);
        goalOuter.setAttribute("fill", very_light_yellow);
        goalOuter.setAttribute("stroke", dark_yellow);
        break;
      case 's':
        goalInner.setAttribute("fill", "#888888");
        goalOuter.setAttribute("fill", very_light_silver);
        goalOuter.setAttribute("stroke", "#888888");
        break;
    }
