const f = (() => {
  ...
  if (["r", "g", "b", "y", "s"].includes(goalID[0]) && goalID[1] >= 0) {
    ...
    switch (goalID[0]) {
      case 'r':
        goalInner.setAttribute("fill", "#bf4945");
        goalOuter.setAttribute("fill", "#e5cfcf");
        goalOuter.setAttribute("stroke", "#bf4945");
        break;
      case 'g':
        goalInner.setAttribute("fill", "#61bf45");
        goalOuter.setAttribute("fill", "#d4e5cf");
        goalOuter.setAttribute("stroke", "#61bf45");
        break;
      case 'b':
        goalInner.setAttribute("fill", "#4572bf");
        goalOuter.setAttribute("fill", "#cfd7e5");
        goalOuter.setAttribute("stroke", "#4572bf");
        break;
      case 'y':
        goalInner.setAttribute("fill", "#c1a530");
        goalOuter.setAttribute("fill", "#e5e1cf");
        goalOuter.setAttribute("stroke", "#c1a530");
        break;
      case 's':
        goalInner.setAttribute("fill", "#777777");
        goalOuter.setAttribute("fill", "#e5e5e5");
        goalOuter.setAttribute("stroke", "#777777");
        break;
    }
